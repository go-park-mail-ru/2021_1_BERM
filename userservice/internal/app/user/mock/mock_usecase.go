...
// Source: user/internal/app/user/usecase (interfaces: UseCase)
...
func (m *MockUseCase) Change(arg0 models.ChangeUser, arg1 context.Context) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) Create(arg0 models.NewUser, arg1 context.Context) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) Verification(arg0, arg1 string, arg2 context.Context) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
