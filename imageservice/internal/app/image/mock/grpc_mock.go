...
// Source: imageservice/api (interfaces: UserClient)
...
// SetImgUrl mocks base method.
func (m *MockUserClient) SetImgUrl(arg0 context.Context, arg1 *api.SetImgUrlRequest, arg2 ...grpc.CallOption) (*api.UserInfoResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "SetImgUrl", varargs...)
	ret0, _ := ret[0].(*api.UserInfoResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SetImgUrl indicates an expected call of SetImgUrl.
func (mr *MockUserClientMockRecorder) SetImgUrl(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetImgUrl", reflect.TypeOf((*MockUserClient)(nil).SetImgUrl), varargs...)
}
